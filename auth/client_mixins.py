from mongoengine import StringField, IntField, ObjectIdField, DictField
from authlib.common.encoding import json_loads, json_dumps
from authlib.oauth2.rfc6749 import ClientMixin
from authlib.oauth2.rfc6749.util import scope_to_list, list_to_scope


class OAuth2MongoClientMixin(ClientMixin):
    client_id = ObjectIdField(primary_key=True)
    client_secret = StringField(max_length=120)
    client_id_issued_at = IntField(null=False, default=0)
    client_secret_expires_at = IntField(null=False, default=0)
    _client_metadata = DictField(db_field="client_metadata")
